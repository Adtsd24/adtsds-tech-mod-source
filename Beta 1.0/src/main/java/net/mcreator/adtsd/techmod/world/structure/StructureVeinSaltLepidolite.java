...
public class StructureVeinSaltLepidolite extends ElementsADtsdsTechMod.ModElement {
	public StructureVeinSaltLepidolite(ElementsADtsdsTechMod instance) {
		super(instance, 273);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 100000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("adtsdstechmod", "veinlepidolite"));
				if (template == null)
					return;
