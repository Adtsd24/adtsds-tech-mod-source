...
public class GuiRefineryGUI extends ElementsADtsdsTechMod.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiRefineryGUI(ElementsADtsdsTechMod instance) {
		super(instance, 439);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(5, this.addSlotToContainer(new Slot(internal, 5, 8, 12) {
				@Override
				...
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemHotOilCell.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			...
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 116, 48) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 152, 48) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("adtsdstechmod:textures/refinerygui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Refinery", 61, 11, -1);
			this.fontRenderer.drawString("Hot Oil", 7, 29, -1);
			this.fontRenderer.drawString("Hydrogen Generator", 7, 65, -1);
		}
