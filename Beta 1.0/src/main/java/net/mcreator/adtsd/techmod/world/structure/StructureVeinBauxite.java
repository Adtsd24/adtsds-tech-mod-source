...
public class StructureVeinBauxite extends ElementsADtsdsTechMod.ModElement {
	public StructureVeinBauxite(ElementsADtsdsTechMod instance) {
		super(instance, 463);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("adtsdstechmod", "veinbauxite"));
				if (template == null)
					return;
