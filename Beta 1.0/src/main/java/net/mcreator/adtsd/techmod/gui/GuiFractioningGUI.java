...
package net.mcreator.adtsd.techmod.gui;
...
import net.mcreator.adtsd.techmod.procedure.ProcedureFractioningRecipes;
...
public class GuiFractioningGUI extends ElementsADtsdsTechMod.ModElement {
	public static int GUIID = 3;
	public static HashMap guistate = new HashMap();
	public GuiFractioningGUI(ElementsADtsdsTechMod instance) {
		super(instance, 442);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 8, 29) {
				@Override
			...
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 8, 65) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
				...
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemHydrogenGenerator.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 116, 29) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 116, 65) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(5, this.addSlotToContainer(new Slot(internal, 5, 152, 29) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(6, this.addSlotToContainer(new Slot(internal, 6, 152, 65) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				ADtsdsTechMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("adtsdstechmod:textures/fractioninggui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Fractioning Tower", 43, 10, -1);
			this.fontRenderer.drawString("Input Liquid", 7, 46, -1);
			this.fontRenderer.drawString("Hydrogen Generator", 7, 82, -1);
		}
		...
		protected void actionPerformed(GuiButton button) {
			ADtsdsTechMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (slotID == 1 && changeType == 0) {
			{
				...
				ProcedureFractioningRecipes.executeProcedure($_dependencies);
			}
		}
