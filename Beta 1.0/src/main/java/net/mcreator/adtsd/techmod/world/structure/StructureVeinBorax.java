...
public class StructureVeinBorax extends ElementsADtsdsTechMod.ModElement {
	public StructureVeinBorax(ElementsADtsdsTechMod instance) {
		super(instance, 98);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("adtsdstechmod", "veinborax"));
				if (template == null)
					return;
