...
public class StructureVeinCoal extends ElementsADtsdsTechMod.ModElement {
	public StructureVeinCoal(ElementsADtsdsTechMod instance) {
		super(instance, 99);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 100000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("adtsdstechmod", "veincoal"));
				if (template == null)
					return;
