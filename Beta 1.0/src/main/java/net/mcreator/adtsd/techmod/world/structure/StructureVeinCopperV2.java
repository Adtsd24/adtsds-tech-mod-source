...
public class StructureVeinCopperV2 extends ElementsADtsdsTechMod.ModElement {
	public StructureVeinCopperV2(ElementsADtsdsTechMod instance) {
		super(instance, 95);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 100000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("adtsdstechmod", "veincopperv2"));
				if (template == null)
					return;
