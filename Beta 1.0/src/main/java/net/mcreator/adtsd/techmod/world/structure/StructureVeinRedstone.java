...
public class StructureVeinRedstone extends ElementsADtsdsTechMod.ModElement {
	public StructureVeinRedstone(ElementsADtsdsTechMod instance) {
		super(instance, 97);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("adtsdstechmod", "veinredstone"));
				if (template == null)
					return;
