...
public class StructureVeinIron extends ElementsADtsdsTechMod.ModElement {
	public StructureVeinIron(ElementsADtsdsTechMod instance) {
		super(instance, 100);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 1000000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("adtsdstechmod", "veiniron"));
				if (template == null)
					return;
