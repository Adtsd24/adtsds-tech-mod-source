...
public class ItemResistor100Ohm extends ElementsADtsdsTechMod.ModElement {
	@GameRegistry.ObjectHolder("adtsdstechmod:resistor100ohm")
	public static final Item block = null;
	public ItemResistor100Ohm(ElementsADtsdsTechMod instance) {
		super(instance, 319);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("adtsdstechmod:resistor100ohm", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("resistor100ohm");
			setRegistryName("resistor100ohm");
		...
		public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
			...
			list.add("\"But sir, didnt you technically make it worse?\"");
			list.add(
